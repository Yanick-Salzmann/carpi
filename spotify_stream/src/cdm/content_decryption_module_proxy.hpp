#ifndef CARPI_CONTENT_DECRYPTION_MODULE_PROXY_HPP
#define CARPI_CONTENT_DECRYPTION_MODULE_PROXY_HPP
...
#include "content_decryption_module_export.hpp"
#if defined(_MSC_VER)
...
#endif //CARPI_CONTENT_DECRYPTION_MODULE_PROXY_HPP
