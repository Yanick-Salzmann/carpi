    ...
    class HereApi {
        calc_route(from, to, full_details) {
            ...
            if (full_details) {
                ...
                leg_attribs += "&maneuverAttributes=startAngle,action,roadName,nextRoadName,travelTime,length,direction,notes,signPost,freewayExit,freewayJunction,roadShield"
            }
